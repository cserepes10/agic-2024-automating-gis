...
def search_and_replace_web_maps(target_service, new_service):
    ...
    """
    layer_out_file = r"D:\COG_ADMIN\MISC_PROJECTS\agic-2024-automating-gis\scripts\out-files\layer-out-file.txt"
        ...
        for item in web_maps:
            ...
            for layer in layers:
                try:
                    ...
                    arcpy.AddWarning(f"Error processing layer: {str(e)}")
            if updated:
                web_map.update()
